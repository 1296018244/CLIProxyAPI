...
// GetUsageStatistics returns the current in-memory usage statistics snapshot.
...
// ExportUsageStatistics returns a portable usage statistics snapshot payload.
...
// ImportUsageStatistics merges a portable usage statistics snapshot payload.
